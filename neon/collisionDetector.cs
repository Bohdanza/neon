    ...
    public class CollisionDetector
    {
        ...
        public bool ObjectsCollide(MapObject mapObject1, MapObject mapObject2)
        {
            ...
            for (int i = 0; i < mapObject1.Hitbox.Count; i++)
            {
                ...
                if (!((minmax2.X < minmax1.X && minmax1.X < minmax2.Y && minmax2.Y < minmax1.Y)
                    || (minmax1.X < minmax2.X && minmax2.X < minmax1.Y && minmax1.Y < minmax2.Y)
                    || (minmax1.X < minmax2.X && minmax2.Y < minmax1.Y)
                    || (minmax2.X < minmax1.X && minmax1.Y < minmax2.Y)))
                    return false;
            }
